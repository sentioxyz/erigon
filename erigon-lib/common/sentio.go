...
import "github.com/erigontech/erigon-lib/common/hexutility"
...
type SentioTraceConfig struct {
	...
	MockFunctions         map[Address]map[string]hexutility.Bytes // contract address => function selector => return data
